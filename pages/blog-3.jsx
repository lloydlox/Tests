...
import Instagram from '@/components/sidebar/instagram';
import Pagination from '@/components/sidebar/pagination';
import PopularPost from '@/components/sidebar/popular-post';
import PostCategory from '@/components/sidebar/post-category';
...
const quetePostList = [
  {
    ...
    imgAlt: 'blog thumb',
    queteText:
      'Quickly morph empowered ideas through viral systems niquely opensource metricss whereas premium human capital creater bjectively underwhelm world-class total.',
    title: 'Interactively Morph High Standards Anding',
    desc: 'Complete deploy focused supply chains rather than viraling services productiva pandemc experiences via interoperable niche markets ramatica incentivize superior functionalitese Rapidiously evolve impactful core competencies without',
    btnText: 'Read More',
    metaList: [
                        ...
                        <div className='post-item style-2'>
                          <div className='post-inner'>
                            ...
                            <div className='post-content'>
                              ...
                              <p>{val.desc}</p>
                              <Link href='/blog-single' className='lab-btn'>
                                <span>
                                  {val.btnText}{' '}
                        ...
                        <div className='post-item style-2 slider-post'>
                          <div className='post-inner'>
                            <div className='post-thumb post-thumb-slider'>
                              ...
                              <div className='post-thumb-slider-next'>
                                <i className='icofont-double-left'></i>
                              </div>
                              <div className='post-thumb-slider-prev'>
